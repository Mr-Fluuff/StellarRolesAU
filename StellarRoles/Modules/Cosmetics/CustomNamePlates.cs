...
namespace StellarRoles.Modules.Cosmetics
{
    ...
    public class CustomNamePlates
    {
        ...
        {
            NamePlateViewData viewdata = ScriptableObject.CreateInstance<NamePlateViewData>();
        ...
        {
            cnd.Resource = cnd.Resource;
            return CreateNameplateBehaviour(cnd, false);
        }
        ...
        public class PreviewNameplatesPatch
        {
            ...
            {
                if (CustomNameplateViewDatas.TryGetValue(plateID, out var result))
                {
        ...
        public class NameplatesTabOnEnablePatch
        {
            ...
            public static float CreateNameplatePackage(List<(NamePlateData, NameplateExtenstion)> nameplates, string packageName, float YStart, NameplatesTab __instance)
            {
                ...
                if (textTemplate != null)
                {
                    ...
                    title.fontSize = 5f;
                    title.fontSizeMax = 5f;
                    title.fontSizeMin = 0f;
